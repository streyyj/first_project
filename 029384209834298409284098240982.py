...
# name: FCardAutoMatchAndPlayOnce

from .. import loader, utils
from hikkatl.tl.custom import MessageButton

@loader.tds
class FCardAutoMatchAndPlayOnceMod(loader.Module):
    """Автоматическое нажатие кнопок 'Матч' и 1 раз 'Играть матч' в @F_CardBot"""
    ...
    async def менюcmd(self, message):
        """Отправить 'Меню', нажать 'Матч' и затем 1 раз 'Играть матч'"""
        ...
        try:
            ...
            # Шаг 3: Нажимаем кнопку "Играть матч" 1 раз
